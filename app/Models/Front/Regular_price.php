 ...
 */
class Regular_price extends Model
{
    /**
     * @var array
     */
    protected $fillable = ['room_type_id', 'day_1', 'day_1_amount', 'day_2', 'day_2_amount', 'day_3', 'day_3_amount', 'day_4', 'day_4_amount', 'day_5', 'day_5_amount', 'day_6', 'day_6_amount', 'day_7', 'day_7_amount', 'created_at', 'updated_at'];
