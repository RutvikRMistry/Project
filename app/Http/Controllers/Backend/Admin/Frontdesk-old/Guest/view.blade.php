...
<div>
   ...
   <div class="page-header"style="height: 5px;" >
      <h1 class="page-title">Guest Detail</h1>
	  <div class="page-header-actions">
         <a href="{{route('backend.admin.frontdesk.guest')}}">
         <button type="button" class="btn btn-primary fa fa-list" > Guest List</button></a>
      </div>
            ...
            <div class="panel">
               <div class="panel-body nav-tabs-animate nav-tabs-horizontal" data-plugin="tabs">
                  <ul class="nav nav-tabs" role="tablist">
                     <li class="nav-item" role="presentation"><a class="nav-link active" data-toggle="tab" href="#activities" aria-controls="activities" role="tab"><i class="icon wb-order" aria-hidden="true"></i>Details</a></li>
                     ...
                     <li class="nav-item dropdown" style="display: none;">
                        ...
                        <div class="dropdown-menu" role="menu">
                           <a class="dropdown-item" data-toggle="tab" href="#activities" aria-controls="activities" role="tab">Details</a>
                                ...
                                <div class="col-md-3">
                                    <div class="tile">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center bg-tsk-o-1" style="background-color:#eee;">
											@if($guest->vip)
                                                <div class="vip"><h4 align="right">VIP</h4></div>
                                            @endif
                                                <div class="img">
                                                    <img src="{{ asset('uploads/'.$guest->picture)}}" id="preview_img" data-oldimg="" class="img-thumbnail" style="max-height: 200px;border-radius: 50%" >
                                                </div>
                                                <dl class="row">
                                            ...
                                            <form action="{{route('backend.admin.frontdesk.guest.update',$guest->id)}}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-row justify-content-center">
                                                    ...
                                                    <div class="form-group col-md-4">
														...
														<span class="text-danger">{{$errors->first('id_card_image')}}</span>
                                                    </div>
