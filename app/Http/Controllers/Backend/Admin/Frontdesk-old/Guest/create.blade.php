         ...
         <div class="examm">
            ...
            <div class="row">
               <div class="col-lg-4">
				  ...
				  <select class="form-control" data-plugin="select2" name="sex">
            ...
            <div class="row">
               <div class="col-lg-4">
                  ...
                  <div class="input-group">
                     ...
                     <input type="text" class="form-control" data-plugin="datepicker" data-multidate="true" name="dob" id="dob" value="{{old('dob',date('Y/m/d'))}}">
                  </div>
               </div>
               <div class="col-lg-4">
                  <h5>VIP:</h5>
