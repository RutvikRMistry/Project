...
@section('content')
    ...
    <div class="card">
        <div class="card-header bg-white">
            <h2>Staff
                <a class="btn btn-tsk float-right" href="{{route('backend.admin.frontdesk.staff')}}"><i class="fa fa-list"></i> Staff List</a>
                    ...
                    <div class="tile">
                        <div class="card">
                            <div class="card-body text-center bg-tsk-o-1">
                                <div class="img">
                                    <img src="{{asset('uploads/'.$staff->picture)}}" id="preview_img" data-oldimg="" class="img-thumbnail" style="max-height: 100px;border-radius: 75%" >
                                </div>
                                <dl class="row">
                            ...
                            <form action="{{route('backend.admin.frontdesk.staff.update',$staff->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row justify-content-center">
                                    <div class="form-group col-sm-12">
                                        <hr/>
                                        <button type="submit" class="btn btn-block btn-dark"><i class="fa fa-save"></i> Update</button>
                                    </div>
                                </div>
