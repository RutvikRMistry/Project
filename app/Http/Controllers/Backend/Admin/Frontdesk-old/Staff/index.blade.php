			 ...
			 <header class="panel-heading">
				...
				<div>
				  <table class="table table-sm table-condensed mb-0">
                    ...
                    <tr>
                        <td><a href="{{route('backend.admin.frontdesk.staff.edit',$staff->id)}}">{{$staff->full_name}}</a></td>
                        <td>{{$staff->email}}</td>
                        <td>{{$staff->phone}}</td>
                        ...
                        <td class="text-right">
                                ...
                                <a href="{{route('backend.admin.frontdesk.staff.edit',$staff->id)}}" class="btn btn-outline-tsk"><i class="fa fa-eye"></i> </a>
