    ...
    <div class="card">
        <div class="card-header bg-white">
            <h2>Edit Paid Service
                <a class="btn btn-tsk float-right" href="{{route('backend.admin.frontdesk.hotel_configure.paid_service')}}"><i class="fa fa-list"></i> Paid Service List</a>
            ...
            <form action="{{route('backend.admin.paid_service.update',$paidService->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group col-md">
                        ...
                        <input type="text" class="form-control form-control-lg" name="title" placeholder="Title" value="{{$paidService->title}}" >
						<span class="text-danger">{{$errors->first('title')}}</span>
                    </div>
                    <div class="form-group col-md ">
                        <label><strong>Price</strong> <small class="text-danger">*</small></label>
                        <input type="text" class="form-control  form-control-lg" name="price" placeholder="Price" value="{{$paidService->price}}">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
						...
						data-plugin="switchery" {{$paidService->status?'checked':''}}>
                    </div>
                </div>
                <div class="form-row justify-content-center">
