 ...
 <div class="page">
	...
	<div class="page-main">
	   <div class="page-header">
		  <h1 class="page-title">Coupons Master</h1>
	   </div>
			 ...
			 <header class="panel-heading">
					  ...
					  <label>
						 <span class="btn tablesaw-btn btn-select tablesaw-btn-select">
							...
							<select>
							   ...
							   <option value="0_desc">2↓</option>
							   <option value="1_asc">3</option>
							</select>
						 </span>
					  </label>
				   </div>
				...
				<div style="width: 50%; float: right;">
				   <div class="btn-group" aria-label="Button group with nested dropdown" role="group" style="float: right; padding-top: 10px;">
					  <a href="{{route('backend.admin.frontdesk.hotel_configure.coupon.create')}}">
					  <button type="button" class="btn btn-primary" style="margin: auto;"><i class="icon wb-plus mr-10" aria-hidden="true"></i>Create Coupon</button></a>
				   </div>
				</div>
				<div>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="btn-group btn-group-sm">
                                <a href="{{route('backend.admin.frontdesk.hotel_configure.coupon.edit',$couponMaster->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row">
								<i class="icon wb-edit"></i> edit</a>
								<a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
               data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$couponMaster->id}},'{{route('backend.admin.frontdesk.hotel_configure.coupon.delete',$couponMaster->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
                            </div>
                        </td>
                    </tr>
                        @endforeach
