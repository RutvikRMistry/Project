	...
	<div class="page-main">
	   ...
	   <div style="width: 100%; padding: 30px;">
		  <div class="panel-body" style="background-color: #fff; ">
			 <div>
				<form action="{{route('backend.admin.room.store')}}" method="post" enctype="multipart/form-data">
					{{csrf_field()}}
				   ...
				   <div class="row" style="margin: auto;">
					  <div class="col-lg-6 ">
						 ...
						 <select class="form-control" data-plugin="select2" name="floor" >
							<option value="">--Select--</option>
							@foreach($floors as $floor)
                                <option value="{{$floor->id}}" {{$floor->id == 'old(floor)'?'selected':''}} >{{$floor->name}}</option>
					  ...
					  <div class="col-lg-6 ">
						 ...
						 <select class="form-control" data-plugin="select2" name="room_type">
							<option value="">--Select--</option>
				   ...
				   <div class="col-lg-4 ">
					  ...
					  <div class="input-group">
						 <div class="float-left mr-20">
							<input type="checkbox"  data-plugin="switchery" id="status" name="status" />
						 </div>
