			 ...
			 <div>
				<div class="row">
				   ...
				   <div class="col-lg-6">
					  ...
					  <input type="text" class="form-control " name="short_code" placeholder="Short Code" value="{{old('short_code')}}" >
				...
				<div class="row">
				   <div class="col-lg-4">
					  ...
					  <div class="example">
						 <input type="text" class="form-control" data-plugin="asSpinner" name="higher_capacity" placeholder="Higher Capacity"  value="{{old('higher_capacity')}}" />
				   ...
				   <div class="col-lg-4">
					  ...
					  <div class="example">
						 <input type="text" class="form-control" data-plugin="asSpinner" name="kids_capacity" placeholder="Kids Capacity" value="{{old('kids_capacity')}}" />
				   ...
				   <div class="col-lg-4">
					  ...
					  <div class="example">
						 <input type="text" class="form-control" data-plugin="asSpinner" name="base_price" placeholder="Base Price"  value="{{old('base_price')}}" />
				   ...
				   <div class="col-lg-4">
					  ...
					  <div class="input-group">
						 <div class="float-left mr-20">
							<input type="checkbox" id="status"  data-plugin="switchery" name="status" />
						 </div>
