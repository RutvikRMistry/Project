<?php
namespace App\Http\Controllers\Backend\Admin\Frontdesk\PaymentSetting;
...
class GatewayController extends Controller
{
    ...
    public function index($type=null){
        ...
        $items = $items->get();
        return view('backend.admin.frontdesk.payment_settings.gateway', compact('items'));
    }
    ...
    public function paymentLog($id=null){
        ...
        return view('backend.admin.frontdesk.payment_settings.payment_log', compact('logs','gateway'));
    }
