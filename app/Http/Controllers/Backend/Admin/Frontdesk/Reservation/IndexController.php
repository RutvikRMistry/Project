<?php
namespace App\Http\Controllers\Backend\Admin\Frontdesk\Reservation;

use App\Model\Frontdesk\AppliedCouponCode;
use App\Model\Frontdesk\CouponMaster;
use App\Model\Frontdesk\Gateway;
use App\Model\Frontdesk\PaidService;
use App\Model\Frontdesk\Payment;
use App\Model\Frontdesk\Reservation;
use App\Model\Frontdesk\ReservationNight;
use App\Model\Frontdesk\ReservationPaidService;
use App\Model\Frontdesk\ReservationTax;
use App\Model\Frontdesk\Room;
use App\Model\Frontdesk\RoomType;
use App\Model\Frontdesk\TaxManager;
use App\Model\Frontdesk\Transaction;
...
class IndexController extends Controller
{
    ...
    public function index($booking_type = null){
        ...
        return view('backend.admin.frontdesk.reservation.index',compact('reservations'));
    }
    ...
    public function create(){
        ...
        return view('backend.admin.frontdesk.reservation.create',compact('guests','room_types','tax'));
    }
   ...
   public function view($id){
        ...
        return view('backend.admin.frontdesk.reservation.view',compact('reservation','gateways','paid_services'));
    }
