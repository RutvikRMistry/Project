...
class Eventdetail extends Model
{
    ...
    {
        return $this->belongsTo('App\Model\Banquet\Bookingdetail', 'booking_id');
    }
    ...
    {
        return $this->belongsTo('App\Model\Banquet\Owner');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Additionalinfo', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Addtask', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\AdminPayment', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Caterer', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Contactus', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Deposit', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Discussion', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Document', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EatingTime', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EventDecorator', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EventEntertainment', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EventEquipment', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EventMenu', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EventMiscellaneou', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EventPhotographer', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EventStaff', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EventTaskAssigne', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EventTime', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\EventValetParking', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Finacial', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\GuestPickup', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Kid', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Managecontact', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Note', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Payment', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Model\Banquet\Setuptear', 'event_id');
    }
}
