...
class Business extends Model
{
    ...
    {
        return $this->belongsTo('App\Model\Pos\Currency');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\Barcode');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\Booking');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\Brand');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\CashRegister');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\Category');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\CustomerGroup');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\ExpenseCategory');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\InvoiceLayout');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\InvoiceScheme');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\PackagePermission');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\PaymentAccount');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\Printer');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\ProductRack');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\ReferenceCount');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\ResTable');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\Role');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\TaxRate');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\Unit');
    }
    ...
    {
        return $this->hasMany('App\Model\Pos\VariationTemplate');
    }
}
