...
@section('title',"List Stock Adjustments")
@section('content')
 ...
 <div class="page">
  ...
  <div class="page-main">
   <div class="page-header">
      <h1 class="page-title">List Stock Adjustments </h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.stock_adjustment.add')}}">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.pos.stock_adjustment.view')}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
