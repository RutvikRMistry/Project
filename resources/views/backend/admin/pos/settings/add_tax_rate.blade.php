 ...
 <div class="page">
   ...
   <div style="width: 100%; padding: 30px;">
      <div class="panel-body" style="background-color: #fff; ">
        <div>
			<form action="{{route('backend.admin.pos.setting.tax_rate.create')}}" method="post">
				{{csrf_field()}}
            <div class="row">
               <div class="col-lg-12">
            ...
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <input class="form-control input_number"  name="amount" type="text" id="amount" value="{{old('amount')}}" required />
