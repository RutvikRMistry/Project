...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Units    <small class="text-muted">Manage your Units</small></h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.setting.unit.add')}}">
				...
				@foreach($unit as $u)
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.pos.setting.unit.edit',$u->id)}}">
						   ...
						   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$u->id}},'{{route('backend.admin.pos.setting.unit.delete',$u->id)}}');">
