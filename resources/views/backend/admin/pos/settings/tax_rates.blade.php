...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Tax Rates    <small class="text-muted">Manage your Tax</small></h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.setting.tax_rate.add')}}">
   ...
   @include('backend.partials.flash_message')
         ...
         <header class="panel-heading">
            ...
            <div>
               <table class="table table-hover dataTable table-striped w-full dtr-inline" data-plugin="dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1783px;">
				...
				@foreach($tax as $t)
                     <tr>
                        <td style="width:33%;">{{$t->name}} </td>
                        <td style="width:33%;">{{$t->amount}}</td>
                        <td class="actions" style="width:33%;">
                          <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-editing save-row"
                           ...
                           <a href="{{route('backend.admin.pos.setting.tax_rate.edit',$t->id)}}">
                           <button type="button" class="btn btn-primary"> <i class="icon wb-edit">  </i> </button></a>
						   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$t->id}},'{{route('backend.admin.pos.setting.tax_rate.delete',$t->id)}}');">
								<button type="button" class="btn btn-danger"><i class="icon wb-trash " aria-hidden="true"></i></button></a>
                        </td>
                     </tr>
				@endforeach
                  </tbody>
      ...
      <div class="page-main">
         <div class="page-header">
            <h1 class="page-title">Tax groups ( Combination of multiple taxes )</h1>
            <div class="page-header-actions">
               <a href="{{route('backend.admin.pos.setting.tax_rate.addmultiple')}}">
               <button type="button" class="btn btn-primary" style="margin: auto;"><i class="icon wb-plus mr-10" aria-hidden="true"></i>Add </button></a>
            </div>
         </div>
         <div style="width: 100%; padding: 30px;">
		@if(Session::has('msg1'))
			<div class="row">	
				<div class="col-md-12">
					<div class="alert alert-danger">{{session::get('msg1')}}
					</div>
				</div>
			</div>
		@endif
