...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Invoice Settings    <small class="text-muted">Manage your brands</small></h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.setting.invoice.add')}}">
                     ...
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-editing cancel-row"
                              data-toggle="tooltip" data-original-title="Delete" hidden><i class="icon wb-edit" aria-hidden="true"></i></a>
                          
						   <button type="button" class="btn btn-primary"> <i class="icon wb-edit">  </i>Edit </button></a>
                           <a href="{{route('backend.admin.pos.setting.invoice.add',)}}">
