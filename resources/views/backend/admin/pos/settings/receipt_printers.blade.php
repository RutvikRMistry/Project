...
@section('title',"Receipt Printer Settings")
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Printers    <small class="text-muted">Manage your Printers</small></h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.setting.receipt_printer.add')}}">
               ...
               <table class="table table-hover dataTable table-striped w-full dtr-inline" data-plugin="dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1783px;">
                  <thead>
                     <tr>
                        ...
                        <th>Capbility Profile</th>
                        <th>Character Per Line</th>
                        <th>Ip Address</th>
                        <th>Port </th>
                        <th>Path</th>
                        <th>Action</th>
				...
				@foreach($printer as $print)
                     <tr>
                        <td>{{$print->name}}</td>
                        <td>{{$print->connection_type}}</td>
                        <td>{{$print->capability_profile}}</td>
                        <td>{{$print->char_per_line}}</td>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.pos.setting.receipt_printer.edit',$print->id)}}">
						   ...
						   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$print->id}},'{{route('backend.admin.pos.setting.receipt_printer.delete',$print->id)}}');">
