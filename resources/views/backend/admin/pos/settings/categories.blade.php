...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Categories    <small class="text-muted">Manage your Categories</small></h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.setting.category.add')}}">
				...
				@foreach($category as $cat)
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.pos.setting.category.edit',$cat->id)}}">
						   ...
						   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$cat->id}},'{{route('backend.admin.pos.setting.category.delete',$cat->id)}}');">
