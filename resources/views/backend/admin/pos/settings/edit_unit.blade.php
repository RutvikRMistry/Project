 ...
 <div class="page">
   ...
   <div style="width: 100%; padding: 30px;">
      <div class="panel-body" style="background-color: #fff; ">
        ...
        <div>
			<form action="{{route('backend.admin.pos.setting.unit.update',$unit->id)}}" method="post">
				{{csrf_field()}}
            <div class="row">
               <div class="col-lg-12">
                  <h5> Name<strong class="text-danger">*</strong></h5>
                  <input class="form-control"  placeholder="Name" name="actual_name" type="text" id="actual_name" value="{{$unit->actual_name}}" required />
            ...
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <input class="form-control" placeholder="Short name" name="short_name" type="text" id="short_name" value="{{$unit->short_name}}" required />
            ...
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <select class="form-control" id="allow_decimal" name="allow_decimal" value="{{old('allow_decimal')}}" required>
                     ...
                     <option value="1" {{$unit->allow_decimal == '1'?'selected':''}}>Yes</option>
                     <option value="0" {{$unit->allow_decimal == '0'?'selected':''}}>No</option>
                  </select>
