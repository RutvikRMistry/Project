...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Brands    <small class="text-muted">Manage your brands</small></h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.setting.brand.add')}}">
				...
				@foreach($brand as $b)
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.pos.setting.brand.edit',$b->id)}}">
						   ...
						   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$b->id}},'{{route('backend.admin.pos.setting.brand.delete',$b->id)}}');">
