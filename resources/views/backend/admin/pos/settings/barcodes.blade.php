...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Barcodes  <small class="text-muted">Manage your barcode settings</small></h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.setting.barcode.add')}}">
				 ...
				 @foreach($barcode as $bar)
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.pos.setting.barcode.edit',$bar->id)}}">
						   ...
						   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$bar->id}},'{{route('backend.admin.pos.setting.barcode.delete',$bar->id)}}');">
