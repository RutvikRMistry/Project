      ...
      <div class="page-main">
        <div class="page-header">
         ...
         <div class="page-header-actions">
           <a href="{{route('backend.admin.pos.sell.add')}}">
                      <button type="button" class="btn btn-primary" style="margin: auto;"><i class="icon wb-plus mr-10" aria-hidden="true"></i>Add </button></a></div>
...
<td>
                 ...
                 <td class="actions">
                   ...
                   <a href="{{route('backend.admin.pos.sell.add')}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                    ...
                    <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
                      ...
                      data-toggle="tooltip" data-original-title=" Print"><i class="fa fa-print" aria-hidden="true"></i></a>
                       <a href="{{route('backend.admin.pos.sell.view')}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                      data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
                     <a href="{{route('backend.admin.pos.sell.payment')}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
...
<td>
                 ...
                 <td class="actions">
                    ...
                    <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-editing cancel-row"
                      data-toggle="tooltip" data-original-title="Delete" hidden><i class="icon wb-close" aria-hidden="true"></i></a>
                  <a href="../../pos/sell/add_sale.html" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                      data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
                    <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
                      data-toggle="tooltip" data-original-title="Delete"><i class="icon wb-trash" aria-hidden="true"></i></a>
                       <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
...
<td>
   ...
   <tr>
                  <td colspan="4" class="bg-secondary text-white"><center>Total</center></td>
                  <td class="bg-secondary text-white" >  Paid - 4</td>
                  <td class="bg-secondary text-white">202.00 $</td>
                  <td class="bg-secondary text-white">202.00 $</td>
