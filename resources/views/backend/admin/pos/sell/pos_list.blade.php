      ...
      <div class="page-main">
        <div class="page-header">
         ...
         <div class="page-header-actions">
           <a href="{{route('backend.admin.pos.sell.pos')}}">
...
<td>
                 ...
                 <td class="actions">
                   ...
                   <a href="{{route('backend.admin.pos.sell.pos')}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                    ...
                    <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
                      ...
                      <a href="../../pos/sell/view_sell.html" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
