  ...
  <div class="page-main">
   ...
   <div style="width: 100%; padding: 30px;">
	<div class="panel-body" style="background-color: #fff; ">
        <div>
        <form action="{{route('backend.admin.pos.product.store')}}" method="post" enctype="multipart/form-data">
			{{csrf_field()}}
            <div class="row">
               <div class="col-lg-4 form-group">
                  <h5>Product Name<strong class="text-danger">*</strong></h5>
                  <input class="form-control" value="{{old('name')}}" placeholder="Product Name" name="name" type="text" id="name" required />
               ...
               <div class="col-lg-4">
                  ...
                  <input class="form-control" placeholder="SKU" name="sku" type="text" id="sku" value="{{old('sku')}}" required />
            ...
            <div class="row">
               <div class="col-lg-4">
                  ...
                  <select class="form-control" data-plugin="select2"  id="barcode_type" name="barcode_type" required >
				   ...
				   @foreach($barcode_types as $k=>$bar)
                        <option value="{{$k}}" {{old('barcode_type') == $k?'selected': ''}}>{{$bar}}</option> 
					@endforeach
               ...
               <div class="col-lg-4">
                  <div class="checkbox-custom checkbox-default">
                     <input type="checkbox"  id="enable_stock"  name="enable_stock" {{old('enable_stock')? 'checked': ''}}/>
               ...
               <div class="col-lg-4">
                  ...
                  <input class="form-control" value="{{old('alert_quantity')}}" placeholder="Alert quantity" min="0" name="alert_quantity" type="number" id="alert_quantity" required />              
            ...
            <div class="row">
               <div class="col-lg-4">
                  ...
                  <div class="input-group input-group-file" data-plugin="inputGroupFile">
                     ...
                     <input id="upload_image" accept="image/*" name="image" type="file" required />
            ...
            <header class="panel-heading">
               <div>
                  <div class="row">
                     <div class="col-lg-4">
                        <div class="checkbox-custom checkbox-default">
                           <input type="checkbox" id="enable_sr_no" name="enable_sr_no" {{old('enable_sr_no')?'checked': ''}}
                              />
                     ...
                     <div class="col-lg-4">
                        <h5>Weight:</h5>
                        <input class="form-control" placeholder="Weight" name="weight" type="text" id="weight" value="{{old('weight')}}">
                  ...
                  <div class="row">
                     <div class="col-lg-3">
                        ...
                        <input class="form-control" placeholder="Custom Field1" name="product_custom_field1"  value="{{old('product_custom_field1')}}" type="text" id="product_custom_field1">              
                     </div>
                     <div class="col-lg-3">
                        <h5>Custom Field 2:</h5>
                        <input class="form-control" placeholder="Custom Field2" name="product_custom_field2" value="{{old('product_custom_field2')}}" type="text" id="product_custom_field2">              
                     </div>
                     <div class="col-lg-3">
                        <h5>Custom Field 3:</h5>
                        <input class="form-control" placeholder="Custom Field3" name="product_custom_field3" value="{{old('product_custom_field3')}}" type="text" id="product_custom_field3">              
                     </div>
                     <div class="col-lg-3">
                        <h5>Custom Field 4:</h5>
                        <input class="form-control" placeholder="Custom Field4" name="product_custom_field4" type="text" value="{{old('product_custom_field4')}}" id="product_custom_field4">              
                     </div>
                  </div>
                  <br>
                  <div class="row">
