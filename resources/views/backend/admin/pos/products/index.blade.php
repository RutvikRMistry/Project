  ...
  <div class="page-main">
   <div class="page-header">
      ...
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.product.add')}}">
	   ...
	   <tbody>
	    @foreach($products as $pro)
		   <tr>
			   ...
			   <td>{{$pro->tax}}</td>
			   <td>{{$pro->sku}} </td>
			   <td>{{$pro->alert_quantity}}</td>
			   <td class="actions">
			   <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-editing save-row"
				  data-toggle="tooltip" data-original-title="Save" hidden><i class="icon wb-wrench" aria-hidden="true"></i></a>
			   <a href="{{route('backend.admin.pos.product.edit',$pro->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
				  data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
			  <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$pro->id}},'{{route('backend.admin.pos.product.delete',$pro->id)}}');">
			   ...
			   <a href="{{route('backend.admin.pos.product.view',$pro->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
				  data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
			   <a href="{{route('backend.admin.pos.product.add_opening_stock')}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
				  data-toggle="tooltip" data-original-title=" Add or edit opening stock"><i class="fa fa-database" aria-hidden="true"></i></a>
			   </td>      
		   </tr>
		@endforeach
	   </tbody>
