...
@section('title',"View Sell Return")
@section('content')
 ...
 <div class="page">
  ...
  <div class="page-main">
   <div class="page-header">
      <h1 class="page-title">Sell Return (Reference No: CN2020/0002)</h1>
   </div>
               ...
               <div class="row">
                  <div class="col-lg-3">
                     ...
                     <address>
                        ...
                        <br>Tax number: 12548692
                        <br>Mobile: 9727785703
                        <br>Email: kintu@kintu.com
                     </address>
                  </div>
