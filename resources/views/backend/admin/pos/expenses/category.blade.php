 ...
 <div class="page">
  ...
  <div class="page-main">
   <div class="page-header">
      <h1 class="page-title">Expense Categories
         <small class="text-muted">Manage your expense categories </small>
      </h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.expenses.add_category')}}">
					...
					@foreach($category as $cat)
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.pos.expenses.edit_category',$cat->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                              data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
                           <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$cat->id}},'{{route('backend.admin.pos.expenses.delete_category',$cat->id)}}');">
