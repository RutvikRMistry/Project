 ...
 <div class="page">
  ...
  <div class="page-main">
    ...
    <div class="row" >
            ...
            <address>
              <strong>walk</strong>
             <br>Mobile: 100</address>
          </div>
                 <div class="col-lg-4 form-group">
            Business:
            <address>
              <strong>AltaVista</strong>
              POS<br>Dubai<br>Dubai,Dubai,UAE</address>
          </div>
                 <div class="col-lg-4 form-group">
          ...
          <table class="table table-striped">
            <tbody><tr>
              ...
              <th class="no-print">Actions</th>
                  ...
                  <td></td>
                  <td class="no-print">
                    <a href="{{route('backend.admin.pos.purchase.edit_payment')}}">
                    <button type="button" class="btn btn-info btn-xs edit_payment" ><i class="glyphicon glyphicon-edit"></i></button> </a>
                  &nbsp; <button type="button" class="btn btn-danger btn-xs delete_payment" ><i class="fa fa-trash" aria-hidden="true"></i></button></td>
                </tr>
                      </tbody></table>
        </div>
