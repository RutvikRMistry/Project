...
@section('content')
 ...
 <div class="page-main">
   <div class="page-header">
      <h1 class="page-title">Roles  <small class="text-muted">Manage Roles</small></h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.office.role.add')}}">
		...
		@foreach($role as $role)
			   ...
			   <td>{{$role->name}}</td>
			    <td class="actions">
                           ...
                           <a href="{{route('backend.admin.pos.office.role.edit',$role->id)}}">
						   ...
						   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$role->id}},'{{route('backend.admin.pos.office.role.delete',$role->id)}}');">
