 ...
 <div class="page">
  ...
  <div class="page-main">
   <div class="page-header">
      <h1 class="page-title">Sales Commission Agents</h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.office.sales_commission.add')}}">
		...
		@foreach($users as $user)
		   ...
		   <tr>
				  ...
				  <td class="actions">
                           ...
                           <a href="{{route('backend.admin.pos.office.sales_commission.edit',$user->id)}}">
                          <i class="icon wb-edit">  </i></a>
						   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$user->id}},'{{route('backend.admin.pos.office.sales_commission.delete',$user->id)}}');">
