...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title"> Register  Report</h1>
   </div>
                        ...
                        <div class="input-group input-group-icon">
                           ...
                           <select class="form-control" data-plugin="select2">
                              <optgroup label="Please Select">
                                 <option value="R1">All Users</option>
                                 <option value="R2">Mr David Felming</option>
                                 <option value="R2">Mr Test</option>
                              </optgroup>
                           </select>
                        </div>
                     </div>
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.pos.report.register.view')}}">
                           <button type="button" class="btn btn-primary"><i class="fa fa-eye"> View </i></button></a>
                        </td>
                     </tr>
                     <tr>
                        <td>05-15-2019 03:19 AM</td>
