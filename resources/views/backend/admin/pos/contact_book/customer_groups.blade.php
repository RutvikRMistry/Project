 ...
 <div class="page">
  ...
  <div class="page-main">
   <div class="page-header">
      <h1 class="page-title">All Customer Groups</h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.contact_book.customer_group.add')}}">
   ...
   <tbody>
		@foreach($group as $grp)
		   <tr>
			   ...
			   <a href="{{route('backend.admin.pos.contact_book.customer_group.edit',$grp->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
				  data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
			   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$grp->id}},'{{route('backend.admin.pos.contact_book.customer_group.delete',$grp->id)}}');">
