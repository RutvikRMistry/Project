 ...
 <div class="page">
  ...
  <div class="page-main">
   <div class="page-header">
      <h1 class="page-title">Suppliers   <small class="text-muted">Manage your Suppliers</small></h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.pos.contact_book.supplier.add')}}">
	   ...
	   <tbody>
		@foreach($contact as $con)
		   <tr>
			   ...
			   <td>{{$con->supplier_business_name}}</td>
			   <td>{{$con->name}}</td>
			   <td>{{$con->mobile}}</td>
			   ...
			   <a href="{{route('backend.admin.pos.contact_book.supplier.edit',$con->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
				  data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
			   <a href="{{route('backend.admin.pos.contact_book.supplier.view',$con->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
			   ...
			   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$con->id}},'{{route('backend.admin.pos.contact_book.supplier.delete',$con->id)}}');">
