	...
	<div class="page-main">
	   ...
	   <div style="width: 100%; padding: 30px;">
		  <div class="panel-body" style="background-color: #fff; ">
			 ...
			 <div>
			<form action="{{route('backend.admin.frontdesk.hotel_configure.room_type.store')}}" method="post" enctype="multipart/form-data">
				{{csrf_field()}}
		  <div class="panel-body" style="background-color: #fff; ">
			 <header class="panel-heading">
			 <div>
				<div class="row">
				   ...
				   <div class="col-lg-6">
					  ...
					  <input type="text" class="form-control " name="short_code" placeholder="Short Code" value="{{old('short_code')}}" required />
				...
				<div class="row">
				   <div class="col-lg-12">
					  ...
					  <textarea id="description" class="form-control " rows="4" name="description" placeholder="Description" >{{old('description')}}</textarea>
				   </div>
				</div>
				<br>
				<div class="row">
				   <div class="col-lg-4">
					  ...
					  <div class="example">
						 <input type="number" class="form-control" data-plugin="asSpinner" name="higher_capacity" placeholder="Higher Capacity"  value="{{old('higher_capacity')}}" required />
				   ...
				   <div class="col-lg-4">
					  ...
					  <div class="example">
						 <input type="number" class="form-control" data-plugin="asSpinner" name="kids_capacity" placeholder="Kids Capacity" value="{{old('kids_capacity')}}"required />
				   ...
				   <div class="col-lg-4">
					  ...
					  <div class="example">
						 <input type="number" class="form-control" data-plugin="asSpinner" name="base_price" placeholder="Base Price"  value="{{old('base_price')}}" required />
				...
				<div class="row">
				   <div class="col-lg-3 ">
					  <li class="mb-15">
						 <input type="checkbox" class="icheckbox-primary" id="amenities_1" name="amenities[]" value="1"
							data-plugin="iCheck" data-checkbox-class="icheckbox_flat-blue"
							/>
						 <label for="amenities_1">Wifi</label>
					  </li>
				   </div>
				   <div class="col-lg-3 ">
					  <li class="mb-15">
						 <input type="checkbox" class="icheckbox-primary" id="amenities_2" name="amenities[]" value="2"
							data-plugin="iCheck" data-checkbox-class="icheckbox_flat-blue"
							/>
						 <label for="amenities_2">Parking</label>
					  </li>
				   </div>
				   <div class="col-lg-3 ">
					  <li class="mb-15">
						 <input type="checkbox" class="icheckbox-primary" id="amenities_3" name="amenities[]" value="3"
							data-plugin="iCheck" data-checkbox-class="icheckbox_flat-blue"
							/>
						 <label for="amenities_3">AC</label>
					  </li>
				   </div>
				   <div class="col-lg-3 ">
					  <li class="mb-15">
						 <input type="checkbox" class="icheckbox-primary" id="amenities_4" name="amenities[]" value="4"
							data-plugin="iCheck" data-checkbox-class="icheckbox_flat-blue"
							/>
						 <label for="amenities_4">BreakFast</label>
					  </li>
				   </div>
				</div>
				<br>
				   ...
				   <div class="col-lg-4">
					  ...
					  <div class="input-group">
						 <div class="float-left mr-20">
							<input type="checkbox" id="status"  data-plugin="switchery" name="status"  {{old('status')?'checked' : ''}}/>
						 </div>
