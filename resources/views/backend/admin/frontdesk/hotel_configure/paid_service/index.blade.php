            ...
            <div>
               <table class="table table-hover dataTable table-striped w-full dtr-inline" data-plugin="dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1783px;">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>{{$key+1}}</td>
						<td><span class="{{$paid_service->icon}}"></span></td>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.paid_service.edit',$paid_service->id)}}"  class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
