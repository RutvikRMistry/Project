...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Gallery ( Category )</h1>
   </div>
         ...
         <header class="panel-heading">
            ...
            <div style="width: 50%; float: right;">
               <div class="btn-group" aria-label="Button group with nested dropdown" role="group" style="float: right; padding-top: 10px;">
                  <a href="{{route('backend.admin.frontdesk.website_setting.gallery.category.create')}}">
				...
				@foreach($category as $category)
                     <tr class="gradeA">
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('admin.web_setting.gallery.category.update',$category->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                              data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
							<a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
               data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$category->id}},'{{route('admin.web_setting.gallery.category.delete',$category->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
