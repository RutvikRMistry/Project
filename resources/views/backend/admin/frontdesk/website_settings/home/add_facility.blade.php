...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Home ( Facility section ) Create</h1>
   </div>
   <div style="width: 100%; padding: 30px;">
      <div class="panel-body" style="background-color: #fff; ">
         <div>
            <form action="{{route('backend.admin.frontdesk.website_setting.home.facility.add')}}" method="post" enctype="multipart/form-data">
				{{csrf_field()}}
			  <div class="row" >
                  <div class="col-lg-8 ">
