...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Home ( Facility section )</h1>
   </div>
   ...
   @include('backend.partials.flash_message')
      <div class="panel-body" style="background-color: #fff; ">
         <header class="panel-heading">
            <div>
               <form action="{{route('backend.admin.frontdesk.website_setting.home.facility')}}" method="post" enctype="multipart/form-data">
			   {{csrf_field()}}
                  <div class="row" >
                     <div class="col-md-12">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-12">
                              <input type="text" class="form-control form-control-lg" id="title_1" name="title_1" value="{{web_setting()->home_facility_section_title_1}}" required>
                           </div>
                        </div>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <div class="form-group row">
                           <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                           <div class="col-md-12">
                              <input type="text" class="form-control form-control-lg" id="title_2" name="title_2" value="{{web_setting()->home_facility_section_title_2}}" required>      
                           </div>
                        </div>
   ...
   <div class="page-main">
      <div class="page-header">
         <h1 class="page-title">FACILITY SECTION ITEM</h1>
      </div>
      <div style="width: 100%; padding: 30px;">
         <div class="panel-body" style="background-color: #fff; ">
            <header class="panel-heading">
               ...
               <div style="width: 50%; float: right;">
                  <div class="btn-group" aria-label="Button group with nested dropdown" role="group" style="float: right; padding-top: 10px;">
                     <a href="{{route('backend.admin.frontdesk.website_setting.home.facility.add')}}">
                     ...
                     <tbody>
						...
						@endphp
							<tr class="gradeA">
							   ...
							   <td>{{$cnt++}}</td>
							   <td><img src="{{asset('uploads/'.$facility->image)}}" alt=".." width="100"></td>
							   <td>{{$facility->name}}</td>
							   <td class="actions">
								  ...
								  <a href="{{route('backend.admin.frontdesk.website_setting.home.facility.edit',$facility->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
									 data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
									<a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
									data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$facility->id}},'{{route('backend.admin.frontdesk.website_setting.home.facility.delete',$facility->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
							   </td>
							</tr>
						@endforeach
                     </tbody>
