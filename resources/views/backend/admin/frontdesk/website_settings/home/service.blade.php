...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Home (Service Section)</h1>
   </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-10">
                           <input type="text" class="form-control form-control-lg" id="title" name="title"
                              value="{{web_setting()->home_service_section_title}}" required >
                        </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <div class="form-group row">
                        <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                        <div class="col-md-10">
                           <input type="text" class="form-control form-control-lg" id="sub_title" name="sub_title" 
                               value="{{web_setting()->home_service_section_sub_title}}" required >
                        </div>
