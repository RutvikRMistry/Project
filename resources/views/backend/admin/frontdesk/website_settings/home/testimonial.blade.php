...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Home ( Testimonial section )</h1>
   </div>
   <div style="width: 100%; padding: 30px;">
   @include('backend.partials.flash_message')
      <div class="panel-body" style="background-color: #fff; ">
         <div>
        <form action="{{route('backend.admin.frontdesk.website_setting.home.testimonial')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
			<div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-12">
                        <input type="text" class="form-control form-control-lg" id="title_1" name="title_1"
                           value="{{web_setting()->home_testimonial_section_title_1}}" required >
                     </div>
                  </div>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-12">
                        <input type="text" class="form-control form-control-lg" id="title_2" name="title_2"
                           value="{{web_setting()->home_testimonial_section_title_2}}" required >      
                     </div>
                  </div>
               </div>
   ...
   <div class="page-main">
      <div class="page-header">
         <h1 class="page-title">Home Item ( Testimonial section )</h1>
      </div>
      <div style="width: 100%; padding: 30px;">
            ...
            <header class="panel-heading">
               ...
               <div style="width: 50%; float: right;">
                  <div class="btn-group" aria-label="Button group with nested dropdown" role="group" style="float: right; padding-top: 10px;">
                     <a href="{{route('backend.admin.frontdesk.website_setting.home.testimonial.add')}}">
               ...
               <div>
                  <table class="table table-hover dataTable table-striped w-full dtr-inline" data-plugin="dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1783px;">
					...
					@php
							$cnt=1;
					@endphp
					@foreach($clientfeed as $clientfeed)
                        <tr class="gradeA">
                           ...
                           <td><img src="{{asset('uploads/'.$clientfeed->image)}}" alt=".." width="100" /></td>
						   
                           <td>{{$clientfeed->name}}</td>
                           <td>{{$clientfeed->title}}</td>
                           <td>{{$clientfeed->feed}}</td>
                           <td class="actions">
                              ...
                              <a href="{{route('backend.admin.frontdesk.website_setting.home.testimonial.edit',$clientfeed->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                                 data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
								 <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
							data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$clientfeed->id}},'{{route('backend.admin.frontdesk.website_setting.home.testimonial.delete',$clientfeed->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
						   </td>
