...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Home ( Testimonial section (Add) )</h1>
   </div>
   <div style="width: 100%; padding: 30px;">
      <div class="panel-body" style="background-color: #fff; ">
         <div>
            <form action="{{route('backend.admin.frontdesk.website_setting.home.testimonial.add')}}" method="post" enctype="multipart/form-data">
				{{csrf_field()}}
			<div class="row" >
               <div class="col-lg-12">
            ...
            <div class="row" >
               <div class="col-lg-12">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-12">
                        <input type="text" class="form-control form-control-lg"  id="feed" name="feed" value="{{old('feed')}}" required >
						 @if($errors->any())
