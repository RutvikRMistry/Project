...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header"style="height: 5px;" >
      <h1 class="page-title">Cms Content</h1>
   </div>
  ...
  @include('backend.partials.flash_message')
      <div class="panel-body" style="background-color: #fff; ">
         <header class="panel-heading">
            <div>
               <form action="{{route('backend.admin.frontdesk.website_setting.blog')}}" method="post" enctype="multipart/form-data">
				   {{csrf_field()}}
				  <div class="row">
                     <div class="col-md-12">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-12">
                              <input type="text" class="form-control form-control-lg" id="title_1" name="title_1"
                                 value="{{web_setting()->blog_blog_section_title_1}}" required>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-12">
                              <input type="text" class="form-control form-control-lg"  id="title_2" name="title_2"
                                 value="{{web_setting()->blog_blog_section_title_2}}" required >
            ...
            <header class="panel-heading">
               ...
               <div style="width: 50%; float: right;">
                  <div class="btn-group" aria-label="Button group with nested dropdown" role="group" style="float: right; padding-top: 10px;">
                     <a href="{{route('backend.admin.frontdesk.website_setting.blog.create')}}">
                  ...
                  <table class="table table-hover dataTable table-striped w-full dtr-inline" data-plugin="dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1783px;">
					...
					@foreach($blog as $blog)
                        <tr class="gradeA">
                           ...
                           <td>
						   <span class="badge  badge-pill  badge-{{ $blog->status ==0 ? 'warning' : 'success' }}">{{ $blog->status == 0 ? 'Deactive' : 'Active' }}</span> 
						   </td>
                           ...
                           <td class="actions">
                              ...
                              <a href="{{route('backend.admin.frontdesk.blog.edit',$blog->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                                 data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
									<a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$blog->id}},'{{route('backend.admin.frontdesk.blog.delete',$blog->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
