					...
					<form action="{{route('blog.update',$blog->id)}}" method="post" enctype="multipart/form-data">
					   ...
					   <div class="row" >
						  <div class="col-lg-12 ">
							 ...
							 <input type="text" class="form-control form-control-lg" value="{{$blog->title}}" name="title" required>
					   ...
					   <div class="row" >
						  <div class="col-lg-12 ">
							...
							@foreach($category as $data)
								<option value="{{$data->id}}" {{$blog->cat_id ==$data->id?'selected':''}}>{{$data->name}}</option>
								@endforeach
							 </select>
						  </div>
					   </div>
					   ...
					   <div class="row" >
						  <div class="col-lg-12 ">
							 ...
							 <input type="text" class="form-control" required placeholder="Enter Here--" name="details" value="{{$blog->details}}">
							 ...
							 <div class="input-group">
								<div class="float-left mr-20">
								   <input type="checkbox" id="inputBasicOff" name="status" data-plugin="switchery"
									  type="checkbox" name="status" {{  ($blog->status == 1 ? ' checked' : '') }} >
