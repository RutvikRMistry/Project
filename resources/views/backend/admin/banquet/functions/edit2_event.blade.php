                     ...
                     <div>
                        ...
                        <div>
                           ...
                           <div class="row">
                              <div class="col-lg-4">
                                 <h5>Client Name:*</h5>
                                 <select id="client" onchange="fillCutomerInfo(this.value)" name="booking_name" class="form-control " tabindex="-1" aria-hidden="true">
                                    ...
                                    <option value="Iron Man (Personal)" selected="selected">Iron Man (Personal)</option>
                                    <option value="Ode Palestine (Personal)">Ode Palestine (Personal)</option>
                                    <option value="Rush Patel (Personal)">Rush Patel (Personal)</option>
                                    <option value="lelo l (Personal)">lelo l (Personal)</option>
                                    <option value="Ammar Aker (Jawwal Palestine)">Ammar Aker (Jawwal Palestine)</option>
                                    <option value="Param Ramanan (Personal)">Param Ramanan (Personal)</option>
                           ...
                           <div class="row" style="padding-top: 10px;">
                              <div class="col-lg-4">
                                 <h5>Sales Team:*</h5>
                                 <select id="sales_team_id" name="sales_team_id" class="form-control " tabindex="-1" aria-hidden="true">
                           ...
                           <div class="row" style="padding-top: 10px;">
                              <div class="col-lg-4">
                                 <h5>Type of Event:*</h5>
                                 <select id="type_event" name="event_type" class="form-control" tabindex="-1" aria-hidden="true">
                              ...
                              <div class="col-lg-4">
                                 <h5>Event Status:*</h5>
                                 <select id="status" name="event_status" class="form-control " tabindex="-1" aria-hidden="true">
                           ...
                           <div class="row" style="padding-top: 10px; padding-bottom: 10px;">
                              <div class="col-lg-4">
                                 ...
                                 <div tabindex="0" class="spinnerUi">
                                    <input placeholder="Guaranteed Guest" min="0" name="guaranteed_guests_veg" type="number" value="100" class="form-control tooltipstered">
                                    <div class="spinnerUi-control"><span class="spinnerUi-up"></span><span class="spinnerUi-down"></span></div>
                                 </div>
                              </div>
                              <div class="col-lg-4">
                                 ...
                                 <div class="input-group">
                                    ...
                                    <input placeholder="Start date" id="from_date" oninput="getDateTimes(this.value)" name="from_date" type="date" value="2019-07-22" class="form-control datepicker tooltipstered">
                                 </div>
                              </div>
                              <div class="col-lg-4">
                                 ...
                                 <div class="input-group">
                                    ...
                                    <input placeholder="End Date" id="to_date" oninput="getDateTimes(this.value)" name="to_date" type="date" value="2019-07-22" class="form-control datepicker tooltipstered">
                                 </div>
                              </div>
                           </div>
                                 ...
                                 <!-- <div class="col-lg-4">
                                    <div class="input-daterange" data-plugin="datepicker">
                                       <div class="input-group">
                                          ...
                                          <input type="time" name="start_time" value="16:46 pm" placeholder="Event Start Time" onchange="" class="form-control timepicker tooltipstered">
                                       </div>
                                       <div class="input-group">
                                          <span class="input-group-addon">to</span>
                                          <input type="time" name="end_time" value="00:49 am" placeholder="Event End Time" onchange="" class="form-control timepicker tooltipstered">                      
                                       </div>
                                    </div>
                                 </div> -->
                                 <!-- <div class="col-lg-2">
                                    <div class="input-group">
                                       ...
                                       <input type="time" name="setup" id="setup_0" value="16:46 pm" placeholder="Setup" onchange="getLocations(0)" class="form-control timepicker tooltipstered">
                                    </div>
                                 </div>
                                 <div class="col-lg-2">
                                    <div class="input-group">
                                       ...
                                       <input type="time" name="teardown" id="teardown_0" value="20:46 pm" placeholder="Tear Down" onchange="getLocations(0)" class="form-control timepicker tooltipstered">
                                    </div>
                                 </div>
                              </div> -->
                              <div class="row" style="padding-top: 10px;">
                                 <div class="col-lg-4">
                                    ...
                                    <select id="location_0" onchange="locationChange(0)" name="location_id" class="form-control" tabindex="-1" aria-hidden="true">
                                 ...
                                 <!-- <div class="col-lg-4 form-group">
                                    ...
                                    <div tabindex="0" class="spinnerUi">
                                       <input type="number" name="location_rent_0" id="location_rent" value="2000" placeholder="Rental price per day" class="form-control tooltipstered">
                                       <div class="spinnerUi-control"><span class="spinnerUi-up"></span><span class="spinnerUi-down"></span></div>
                                    </div>
                                 </div> -->
                              </div>
                           ...
                           <div class="row" style="padding-top:10px;">
                              <div class="col-lg-6">
                                 <select id="managers" name="event_manager" class="form-control" tabindex="-1" aria-hidden="true">
