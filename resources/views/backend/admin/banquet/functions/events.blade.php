...
<div class="page">
        ...
        <div style="width: 100%; ">
                        ...
                        <div class="row" style="margin: auto;">
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="filter[from]" data-plugin="datepicker"
                                        data-multidate="true">
                                </div>
                            </div>
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="filter[to]" data-plugin="datepicker"
                                        data-multidate="true">
                                </div>
                            </div>
                            <div class="col-lg-4 form-group">
            ...
            <div class="row">
                                ...
                                <div class="kcard_details">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a
                                                    href="{{route('backend.admin.banquet.functions.event.edit',$value->id)}}"><i
                                                        class="fa fa-fw fa-pencil"></i> Edit</a></li>
                                            <li><a
                                                    href="{{route('backend.admin.banquet.functions.event.view',$value->id)}}"><i
                                                        class="fa fa-fw fa-eye"></i> View</a></li>
                                            <li><a
                                                    href="{{route('backend.admin.banquet.functions.event.delete',$value->id)}}"><i
                                                        class="fa fa-fw fa-trash"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                    <span class="anni_status">{{$value->event_status}}</span>
                                    <p>Client Name : {{$value->booking_name}}</p>
                                    <p>Function Name: {{$value->event_name}}</p>
                                    <p>Email : {{$value->client_email}}</p>
                                    <p>Mobile : {{$value->client_phone}}</p>
                                    <p>Start Date : {{$value->from_date}}</p>
                                    <p>End Date : {{$value->to_date}}</p>
                                    <a style="list-style-type:none;" item-id="{{ $value->id }}"></a>
                                </div>
                            </div>
                        ...
                        <div class="list-group" id="complete-item-drop">
                            ...
                            <div class="kanban_dragbox">
                                ...
                                <div class="kcard_details">
                                    ...
                                    <span class="marraaige_status">{{$value->event_status}}</span>
                                    <p>Client Name : {{$value->booking_name}}</p>
                                    <p>Function Name: {{$value->event_name}}</p>
                                    <p>Email : {{$value->client_email}}</p>
                                    <p>Mobile : {{$value->client_phone}}</p>
                        ...
                        <div class="list-group" id="converted-item-drop">
                            ...
                            <div class="kanban_dragbox">
                                ...
                                <div class="kcard_details">
                                    ...
                                    <span class="conf_status">{{$value->event_status}}</span>
                                    <p>Client Name : {{$value->booking_name}}</p>
                                    <p>Function Name: {{$value->event_name}}</p>
                                    <p>Email : {{$value->client_email}}</p>
                                    <p>Mobile : {{$value->client_phone}}</p>
                    ...
                    <div class="karnben_cardbox kan_close_card connectedSortable" id="incomplete-item-drop">
                        ...
                        <div class="list-group" id="incomplete-item-drop">
                            ...
                            <div class="kanban_dragbox">
                                ...
                                <div class="kcard_details">
                                    <span class="corpo_status">{{$value->event_status}}</span>
                                    <p>Client Name : {{$value->booking_name}}</p>
                                    <p>Function Name: {{$value->event_name}}</p>
                                    <p>Email : {{$value->client_email}}</p>
                                    <p>Mobile : {{$value->client_phone}}</p>
                ...
                <div class="col-md-2">
                    ...
                    <div class="karnben_cardbox kan_lost_card connectedSortable" id="lost-item-drop">

                        <div class="list-group" id="lost-item-drop">
                            @if(!empty($lostItem) && $lostItem->count())
                            @foreach($lostItem as $value)
                            <div class="kanban_dragbox">

                                <div class="kcard_details">
                                    <span class="birthday_status">{{$value->event_status}}</span>
                                    <p>Client Name : {{$value->booking_name}}</p>
                                    <p>Function Name: {{$value->event_name}}</p>
                                    <p>Email : {{$value->client_email}}</p>
                                    <p>Mobile : {{$value->client_phone}}</p>
            ...
            <!-- <ul class="taskboard-stages ui-sortable" id="taskboardStages">
                <li class="taskboard-stage">
                    <header class="taskboard-stage-header ui-sortable-handle">
                        <div class="taskboard-stage-actions float-right">
                            <div class="dropdown">
                                <a data-toggle="dropdown" href="#" aria-expanded="false"><i class="icon wb-chevron-down"
                                        aria-hidden="true"></i></a>
                                <div class="dropdown-menu bullet" role="menu">
                                    <a class="taskboard-stage-rename dropdown-item" href="javascript:void(0)"
                                        role="menuitem"><i class="icon wb-pencil" aria-hidden="true"></i>Rename</a>
                                    <a class="taskboard-stage-delete dropdown-item" href="javascript:void(0)"
                                        role="menuitem"><i class="icon wb-trash" aria-hidden="true"></i>Delete</a>
                                    <div class="taskboard-stage-rename-wrap">
                                        <div class="form-group">
                                            <input class="form-control taskboard-stage-rename-input" type="text"
                                                value="TO DO" name="name">
                                        </div>
                                        <button class="btn btn-primary btn-block taskboard-stage-rename-save"
                    ...
                    <div class="taskboard-stage-content">
                        <ul class="list-group taskboard-list ui-sortable">
                            <li class="list-group-item priority-urgent" data-taskboard="slidePanel"
                                data-url="panel.tpl">
                                ...
                                <div class="w-full">
                                    <div class="task-badges"><span
                                            class="task-badge task-badge-subtask icon wb-list-bulleted">1/2</span><span
                                            class="task-badge task-badge-attachments icon wb-paperclip">2</span><span
                                            class="task-badge task-badge-comments icon wb-chat">2</span></div>
                            ...
                            <li class="list-group-item priority-high" data-taskboard="slidePanel" data-url="panel.tpl">
                                ...
                                <div class="w-full">
                                    <div class="task-badges"><span
                                            class="task-badge task-badge-subtask icon wb-list-bulleted">0/2</span><span
                                            class="task-badge task-badge-comments icon wb-chat">1</span></div>
                                    <ul class="task-members">
                                        <li><img class="avatar avatar-sm" src="../assets/portraits/5.jpg"></li>
                        ...
                        <div class="action-wrap">
                            <a class="add-item-toggle" href="#"><i class="icon wb-plus" aria-hidden="true"></i>Add
                                Task</a>
                ...
                <li class="taskboard-stage">
                    ...
                    <div class="taskboard-stage-content">
                        <ul class="list-group taskboard-list ui-sortable">
                            <li class="list-group-item priority-normal" data-taskboard="slidePanel"
                                data-url="panel.tpl">
                                <div class="checkbox-custom checkbox-primary">
                                    <input type="checkbox" name="checkbox">
                                ...
                                <div class="w-full">
                                    <div class="task-badges"><span
                                            class="task-badge task-badge-subtask icon wb-calendar">10/29</span><span
                                            class="task-badge task-badge-comments icon wb-chat">1</span></div>
                                    <ul class="task-members">
                                        <li><img class="avatar avatar-sm" src="../../../assets/portraits/5.jpg"></li>
                            ...
                            <li class="list-group-item priority-high" data-taskboard="slidePanel" data-url="panel.tpl">
                                ...
                                <div class="w-full">
                                    <div class="task-badges"><span
                                            class="task-badge task-badge-attachments icon wb-paperclip">3</span></div>
                                    <ul class="task-members">
                                        <li><img class="avatar avatar-sm" src="../../../assets/portraits/5.jpg"></li>
                    ...
                    <div class="taskboard-stage-content">
                        <ul class="list-group taskboard-list ui-sortable">
                            ...
                            <li class="list-group-item priority-normal" data-taskboard="slidePanel"
                                ...
                                <div class="w-full">
                                    <div class="task-badges"><span
                                            class="task-badge task-badge-subtask icon wb-list-bulleted">2/2</span><span
                                            class="task-badge task-badge-comments icon wb-chat">1</span></div>
                                    <ul class="task-members">
                                        <li><img class="avatar avatar-sm" src="../../../assets/portraits/6.jpg"></li>
                                        <li><img class="avatar avatar-sm" src="../../../assets/portraits/6.jpg"></li>
   ...
   <small class="text-muted">BP_Event_05012020114930  </small></td>      -->
                                        ...
                                        <td class="actions">
                                            ...
                                            <a href="{{route('backend.admin.banquet.functions.event.edit',$book->id)}}"
                                                ...
                                                data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit"
                                                    aria-hidden="true"></i></a>
                                            <a href="{{route('backend.admin.banquet.functions.event.delete',$book->id)}}"
                                            ...
                                            <a href="{{route('backend.admin.banquet.functions.event.view',$book->id)}}"
                                                class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                                    ...
                                    <div class="row">
                                        <div style="width: 50%; background-color: #fff; float: left;">
                                            <div class="dataTables_info" id="DataTables_Table_0_info" role="status"
                                                aria-live="polite" style="margin-top: 25px;">Showing 1 to 10 of 12
                                                entries</div>
                                        </div>
...
<script>
$(function() {
    $("#padding-item-drop, #complete-item-drop, #incomplete-item-drop,#converted-item-drop,#lost-item-drop")
        .sortable({
    ...
    $(".connectedSortable").on("sortupdate", function(event, div) {
        ...
        $("#padding-item-drop a").each(function(index) {
            panddingArr[index] = $(this).attr('item-id');
            location.reload(true);
        });

        $("#complete-item-drop a").each(function(index) {
            completeArr[index] = $(this).attr('item-id');
            location.reload(true);
        });

        $("#incomplete-item-drop a").each(function(index) {
            incompleteArr[index] = $(this).attr('item-id');
            location.reload(true);
        });

        $("#converted-item-drop a").each(function(index) {
            convertedArr[index] = $(this).attr('item-id');
            location.reload(true);
        });

        $("#lost-item-drop a").each(function(index) {
