 ...
 <div class="page">
   ...
   <div class="page-header">
      ...
      <div class="page-header-actions">
         <a href="{{route('backend.admin.banquet.task.call.new')}}">
         <button type="button" class="btn btn-primary" style="margin: auto;"><i class="icon wb-plus mr-10" aria-hidden="true"></i> Create Call</button></a>
      </div>
   </div>
                  ...
                  @foreach($call as $call)
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.banquet.task.call.edit',$call->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                  ...
                  @endforeach
                     <!-- <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-editing cancel-row"
                              data-toggle="tooltip" data-original-title="Delete" hidden><i class="icon wb-close" aria-hidden="true"></i></a>
                           <a href="{{route('backend.admin.banquet.task.call.new')}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                              data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
