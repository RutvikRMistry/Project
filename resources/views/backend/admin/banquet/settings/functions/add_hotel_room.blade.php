...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Add Hotel Room</h1>
   </div>
   <div style="width: 100%; padding: 30px;">
      <div class="panel-body" style="background-color: #fff; ">
         <header class="panel-heading">
        <div>
		<form action="{{route('backend.admin.banquet.sttings.function.hotel_room.store')}}" method="post">
			{{csrf_field()}}
            <div class="row" >
               <div class="col-lg-12">
            ...
            <div class="row" >
               <div class="col-lg-12">
                  ...
                  <input type="text" class="form-control" placeholder="Room Name" name="room_name" value="{{old('room_name')}}" required />
