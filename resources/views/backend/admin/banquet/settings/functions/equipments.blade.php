	...
	<div class="page-main">
	   <div class="page-header">
		  ...
		  <div class="page-header-actions">
			 <a href="{{route('backend.admin.banquet.sttings.function.equipment.add')}}">
					  ...
					  @foreach($equipment as $equip)
							<tr>
								...
								<td class="actions">
								   ...
								   <a href="{{route('backend.admin.banquet.sttings.function.equipment.edit',$equip->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
									data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
									<a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
									data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$equip->id}},'{{route('backend.admin.banquet.sttings.function.equipment.delete',$equip->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
								</td>
							</tr>
						@endforeach
					  </tbody>
