...
@section('content')
 ...
 <div class="page">
   ...
   <div class="page-header">
      <h1 class="page-title">Lead Source</h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.banquet.sttings.function.lead_source.add')}}">
					...
					@foreach($lead as $lead)
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.banquet.sttings.function.lead_source.edit',$lead->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                              data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
                            <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$lead->id}},'{{route('backend.admin.banquet.sttings.function.lead_source.delete',$lead->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
                        </td>
                     </tr>
					@endforeach
                  </tbody>
