 ...
 <div class="page">
   ...
   <div style="width: 100%; padding: 30px;">
      <div class="panel-body" style="background-color: #fff; ">
        ...
        <div>
		<form action="{{route('backend.admin.banquet.sttings.function.equipment.store')}}" method="post">
			{{csrf_field()}}
            <div class="row" >
               <div class="col-lg-6">
               ...
               <div class="col-lg-6">
                  ...
                  <input type="text" class="form-control" placeholder=" " name="price" value="{{old('price')}}" required />
