      ...
      <div class="panel-body" style="background-color: #fff; ">
		...
		<form action="{{route('backend.admin.banquet.sttings.function.event_location.store')}}" method="post">
            ...
            <div class="row">
               ...
               <div class="col-lg-4 form-group">
                  <h5>Theater:</h5>
                  <input type="text" class="form-control" data-plugin="asSpinner" name="theater" value="{{old('theater')}}" />
               </div>
            </div>
            <div class="row">
               <div class="col-lg-4">
               ...
               <div class="col-lg-4 form-group">
                  ...
                  <input type="text" class="form-control" data-plugin="asSpinner" name="u_shape" value="{{old('u_shape')}}" required />
				  <span class="text-danger">{{$errors->first('u_shape')}}</span>
               </div>
               <div class="col-lg-4 form-group">
                  <h5>Cabaret:</h5>
                  <input type="text" class="form-control" data-plugin="asSpinner" name="cabaret" value="{{old('cabaret')}}" />
            ...
            <div class="row">
               <div class="col-lg-4">
                  <h5> Classroom:</h5>
                  <input type="text" class="form-control" data-plugin="asSpinner" name="classroom" value="{{old('classroom')}}" />
				  <span class="text-danger">{{$errors->first('classroom')}}</span>
               </div>
               <div class="col-lg-4 form-group">
                  <h5>  Banquet Capacity:<span class="text-danger">*</span></h5>
                  <input type="text" class="form-control" data-plugin="asSpinner" name="banquet" value="{{old('banquet')}}" required />
				  <span class="text-danger">{{$errors->first('banquet')}}</span>
               </div>
               <div class="col-lg-4 form-group">
                  <h5>Booth:</h5>
                  <input type="text" class="form-control" data-plugin="asSpinner" name="booth" value="{{old('booth')}}" />
            ...
            <div class="row">
               <div class="col-lg-4">
                  <h5> Board Room:</h5>
                  <input type="text" class="form-control" data-plugin="asSpinner" name="board_room" value="{{old('board_room')}}" />
				   <span class="text-danger">{{$errors->first('board_room')}}</span>
               </div>
               <div class="col-lg-4 form-group">
                  <h5>  Cocktail:<span class="text-danger">*</span></h5>
                  <input type="text" class="form-control" data-plugin="asSpinner" name="cocktail" value="{{old('cocktail')}}" required />
				  <span class="text-danger">{{$errors->first('cocktail')}}</span>
               </div>
               <div class="col-lg-4 form-group">
                  <h5>Rental Price / Day(₵):<span class="text-danger">*</span></h5>
                  <input type="text" class="form-control" data-plugin="asSpinner" name="location_rent" value="{{old('location_rent')}}" required />
