...
@section('title',"Transportation Service")
@section('content')
	...
	<div class="page-main">
	   <div class="page-header">
		  ...
		  <div class="page-header-actions">
			 <a href="{{route('backend.admin.banquet.sttings.function.transport_service.add')}}">
						...
						@foreach($transport as $transport)
						 <tr>
							...
							<td class="actions">
							   ...
							   <a href="{{route('backend.admin.banquet.sttings.function.transport_service.edit',$transport->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
								  data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
							  <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$transport->id}},'{{route('backend.admin.banquet.sttings.function.transport_service.delete',$transport->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
							</td>
						 </tr>
						@endforeach
					  </tbody>
