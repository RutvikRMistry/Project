 ...
 <div class="page">
   ...
   <div class="page-header">
      ...
      <div class="page-header-actions">
         <a href="{{route('backend.admin.banquet.sttings.function.hotel_room.add')}}">
            ...
            <div class="col-lg-4">
               <select class="form-control" data-plugin="select2">
                  <optgroup label="Please Select">
                     <option value="R1">Courtyard by</option>
                     <option value="R1">Hampton Inn Philadelphia Center </option>
                     <option value="R1">Maarten Kamerling</option>
                  </optgroup>
               </select>
            </div>
         </div>
					...
					@foreach($rooms as $room)
                     <tr>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.banquet.sttings.function.hotel_room.edit',$room->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                              data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
                           <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$room->id}},'{{route('backend.admin.banquet.sttings.function.hotel_room.delete',$room->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
                        </td>
                     </tr>
					@endforeach
                  </tbody>
