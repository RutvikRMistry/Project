 ...
 <div class="page">
   ...
   <div style="width: 100%; padding: 30px;">
      <div class="panel-body" style="background-color: #fff; ">
        ...
        <div>
		<form action="{{route('backend.admin.banquet.sttings.function.parking.update',$parking->id)}}" method="post">
			{{csrf_field()}}
            <div class="row" >
               <div class="col-lg-6">
                  <h4>Name:<span class="text-danger">*</span></h4>
                  <input type="text" class="form-control" placeholder=" " name="type" value="{{$parking->type}}" required />
					  <span class="text-danger">{{$errors->first('type')}}</span>
               </div>
               <div class="col-lg-6">
                  <h4>Capicity:<span class="text-danger">*</span></h4>
                  <input type="text" class="form-control" placeholder=" " name="capacity" value="{{$parking->capacity}}" required />
