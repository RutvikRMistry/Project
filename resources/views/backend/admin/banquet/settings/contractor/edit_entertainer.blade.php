...
<div class="page-main">
   <div class="page-header">
      <h1 class="page-title">Edit Entertainment</h1>
   </div>
   <div style="width: 100%; padding: 30px;">
      <div class="panel-body" style="background-color: #fff; ">
         <header class="panel-heading">
         <div>
		<form action="{{route('backend.admin.banquet.sttings.contractor.entertainer.update',$entertain->id)}}" method="post">
			{{csrf_field()}}
            <div class="row">
               <div class="col-lg-4 form-group">
                  <h5>Name:<span class="text-danger">*</span></h5>
                  <input type="text" class="form-control" placeholder="name" name="name" value="{{$entertain->name}}" required />
				  <span class="text-danger">{{$errors->first('name')}}</span>
               </div>
               <div class="col-lg-4 form-group">
                  <h5>Email ID:<span class="text-danger">*</span></h5>
                  <input type="email" class="form-control" placeholder="Email ID" name="email" value="{{$entertain->email}}" required />
				  <span class="text-danger">{{$errors->first('email')}}</span>
               </div>
               <div class="col-lg-4 form-group">
                  <h5>Phone No:<span class="text-danger">*</span></h5>
                  <input type="number" class="form-control" placeholder="Phone No " name="phone" value="{{$entertain->phone}}" required />
            ...
            <div class="row">
               <div class="col-lg-4 form-group">
                  ...
                  <input type="text" class="form-control" placeholder=" Address" name="address" value="{{$entertain->address}}" required />
            ...
            <div class="row" >
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Contract Terms" name="contract_terms">{{$entertain->contract_terms}}</textarea>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Payment" name="payment">{{$entertain->payment}}</textarea>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Cancellation" name="cancellation">{{$entertain->cancellation}}</textarea>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="force majeure" name="force_majeure">{{$entertain->force_majeure}}</textarea>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="safety and security" name="safety_and_security">{{$entertain->safety_and_security}}</textarea>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="indemnification" name="indemnification">{{$entertain->indemnification}}
                        </textarea>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="binding arbitration" name="binding_arbitration">{{$entertain->binding_arbitration}}
                        </textarea>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="approval" name="approval">{{$entertain->approval}}
                        </textarea>
                     </div>
                  </div>
               </div>
