 ...
 <div class="page">
	...
	<div class="page-main">
	   <div class="page-header">
		  <h1 class="page-title">Edit Decorator</h1>
	   </div>
	   <div style="width: 100%; padding: 30px;">
		  <div class="panel-body" style="background-color: #fff; ">
			 <header class="panel-heading">
			 <div>
			<form action="{{route('backend.admin.banquet.sttings.contractor.decorator.update',$decorator->id)}}" method="post">
				{{csrf_field()}}
				<div class="row">
				   <div class="col-lg-4 form-group">
					  <h5>Name:<span class="text-danger">*</span></h5>
					  <input type="text" class="form-control" placeholder="Name" name="name" value="{{$decorator->name}}" required />
					  <span class="text-danger">{{$errors->first('name')}}</span>
				   </div>
				   <div class="col-lg-4 form-group">
					  <h5>Email ID:<span class="text-danger">*</span></h5>
					  <input type="email" class="form-control" placeholder="email" name="email" value="{{$decorator->email}}" required />
					  <span class="text-danger">{{$errors->first('email')}}</span>
				   </div>
				   <div class="col-lg-4 form-group">
					  <h5>Phone No:<span class="text-danger">*</span></h5>
					  <input type="number" class="form-control" placeholder="phone" name="phone" value="{{$decorator->phone}}" required />
            ...
            <div class="row">
               <div class="col-lg-4 form-group">
                  ...
                  <input type="text" class="form-control" placeholder="address" name="address" value="{{$decorator->address}}" required />
				...
				<div class="row" >
				   <div class="col-md-12">
					  ...
					  <div class="form-group row">
						 ...
						 <div class="col-md-12">
							<textarea class="form-control" rows="3" placeholder="Contract Terms" name="decoration_contract_terms">{{$decorator->decoration_contract_terms}}</textarea>
						 </div>
					  </div>
				   </div>
				</div>
				<div class="row">
				   <div class="col-md-12">
					  ...
					  <div class="form-group row">
						 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
						 <div class="col-md-12">
							<textarea class="form-control" rows="3" placeholder="Decoration Fees" name="decoration_fees">{{$decorator->decoration_fees}}</textarea>
						 </div>
					  </div>
				   </div>
				</div>
				<div class="row">
				   <div class="col-md-12">
					  ...
					  <div class="form-group row">
						 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
						 <div class="col-md-12">
							<textarea class="form-control" rows="3" placeholder="Decoration Arrangements" name="decoration_arrangements">{{$decorator->decoration_arrangements}}</textarea>
						 </div>
					  </div>
				   </div>
				</div>
				<div class="row">
				   <div class="col-md-12">
					  ...
					  <div class="form-group row">
						 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
						 <div class="col-md-12">
							<textarea class="form-control" rows="3" placeholder="Damage To Property"name="damage_to_property">{{$decorator->damage_to_property}}</textarea>
						 </div>
					  </div>
				   </div>
				</div>
				<div class="row">
				   <div class="col-md-12">
					  ...
					  <div class="form-group row">
						 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
						 <div class="col-md-12">
							<textarea class="form-control" rows="3" placeholder="Deposit" name="deposit">{{$decorator->deposit}}</textarea>
						 </div>
					  </div>
				   </div>
				</div>
				<div class="row">
				   <div class="col-md-12">
					  ...
					  <div class="form-group row">
						 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
						 <div class="col-md-12">
							<textarea class="form-control" rows="3" placeholder="Cancellation and Design Change Fees" name="cancellation_and_design_change_fee">{{$decorator->cancellation_and_design_change_fee}}
							</textarea>
						 </div>
					  </div>
				   </div>
				...
				<div class="row">
				   <div class="col-md-12">
					  ...
					  <div class="form-group row">
						 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
						 <div class="col-md-12">
							<textarea class="form-control" rows="3" placeholder="Safety" name="safety">{{$decorator->safety}}
							</textarea>
						 </div>
					  </div>
				   </div>
				...
				<div class="row">
				   <div class="col-md-12">
					  ...
					  <div class="form-group row">
						 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
						 <div class="col-md-12">
							<textarea class="form-control" rows="3" placeholder="Material Guarantee" name="material_guarantee">{{$decorator->material_guarantee}}
							</textarea>
						 </div>
					  </div>
				   </div>
				...
				<div class="row">
				   <div class="col-md-12">
					  ...
					  <div class="form-group row">
						 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
						 <div class="col-md-12">
							<textarea class="form-control" rows="3" placeholder="Making Changes" name="making_changes">{{$decorator->making_changes}}
							</textarea>
						 </div>
					  </div>
				   </div>
				...
				<div class="row">
				   <div class="col-md-12">
					  ...
					  <div class="form-group row">
						 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
						 <div class="col-md-12">
							<textarea class="form-control" rows="3" placeholder="Approval" name="approval">{{$decorator->approval}}
							</textarea>
						 </div>
					  </div>
				   </div>
