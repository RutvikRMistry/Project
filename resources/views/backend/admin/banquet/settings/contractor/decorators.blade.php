 ...
 <div class="page">
	...
	<div class="page-main">
	   <div class="page-header">
		  <h1 class="page-title">Decorator</h1>
		  <div class="page-header-actions">
			 <a href="{{route('backend.admin.banquet.sttings.contractor.decorator.add')}}">
						...
						@foreach($decorator as $deco)
						 <tr>
							...
							<td class="actions">
							   ...
							   <a href="{{route('backend.admin.banquet.sttings.contractor.decorator.edit',$deco->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
								  data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
							   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
									data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$deco->id}},'{{route('backend.admin.banquet.sttings.contractor.decorator.delete',$deco->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
							</td>
						 </tr>
						@endforeach
					  </tbody>
