...
<div class="page-main">
   <div class="page-header">
      ...
      <div class="page-header-actions">
         <a href="{{route('backend.admin.banquet.sttings.contractor.entertainer.add')}}">
                  ...
                  <tbody>
					@foreach($entertainment as $entertain)
                     <tr>
                        ...
                        <td>{{$entertain->address}}</td>
                        <td>{{$entertain->phone}}</td>
                        <td>{{$entertain->email}}</td>
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.banquet.sttings.contractor.entertainer.edit',$entertain->id)}}"class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
                              data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
                           <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
									data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$entertain->id}},'{{route('backend.admin.banquet.sttings.contractor.entertainer.delete',$entertain->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
							</td>
                     </tr>
					@endforeach
                  </tbody>
