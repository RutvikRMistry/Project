    ...
    @include('backend.partials.leftbar.shortcuts')	
		...
		<div class="page-main">
		   <div class="page-header">
			  <h1 class="page-title">Edit Photographers</h1>
		   </div>
		   <div style="width: 100%; padding: 30px;">
			  <div class="panel-body" style="background-color: #fff; ">
				 <header class="panel-heading">
				 <div>
		<form action="{{route('backend.admin.banquet.sttings.contractor.photographer.update',$photo->id)}}" method="post">
			{{csrf_field()}}
			<div class="row">
				   <div class="col-lg-4 form-group">
					  <h5>Name:<span class="text-danger">*</span></h5>
					  <input type="text" class="form-control" placeholder="Name" name="name" value="{{$photo->name}}" required />
					  <span class="text-danger">{{$errors->first('name')}}</span>
				   </div>
				   <div class="col-lg-4 form-group">
					  <h5>Email ID:<span class="text-danger">*</span></h5>
					  <input type="email" class="form-control" placeholder="email" name="email" value="{{$photo->email}}" required />
					  <span class="text-danger">{{$errors->first('email')}}</span>
				   </div>
				   <div class="col-lg-4 form-group">
					  <h5>Phone No:<span class="text-danger">*</span></h5>
					  <input type="number" class="form-control" placeholder="phone" name="phone" value="{{$photo->phone}}" required />
            ...
            <div class="row">
               <div class="col-lg-4 form-group">
                  ...
                  <input type="text" class="form-control" placeholder="address" name="address" value="{{$photo->address}}" required />
					...
					<div class="row" >
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 ...
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="wedding_photography_contract_terms" placeholder="Photography Contract Terms">{{$photo->wedding_photography_contract_terms}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="payment" placeholder="Payment">{{$photo->payment}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="cancellation" placeholder="Cancellation">{{$photo->cancellation}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="reschedule" placeholder="Reschedule">{{$photo->reschedule}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="liability" placeholder="Liability">{{$photo->liability}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="responsibilities" placeholder="Responsibilities">{{$photo->responsibilities}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="coverage" placeholder="Coverage">{{$photo->coverage}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="image_processing" placeholder="Image Processing">{{$photo->image_processing}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="model_release" placeholder="Model Release">{{$photo->model_release}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="copyright" placeholder="Copyright">{{$photo->copyright}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="unauthorized_reproduction" placeholder="Unauthorized Reproduction">{{$photo->unauthorized_reproduction}}</textarea>
					...
					<div class="row">
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" name="approval" placeholder="Approval">{{$photo->approval}}</textarea>
