...
@section('title',"Add Miscellaneous")
@section('content')
    ...
    @include('backend.partials.leftbar.shortcuts')	
		...
		<div class="page-main">
		   <div class="page-header">
			  <h1 class="page-title">Create Miscellaneous</h1>
		   </div>
		   <div style="width: 100%; padding: 30px;">
			  <div class="panel-body" style="background-color: #fff; ">
				 <header class="panel-heading">
				 <div>
				<form action="{{route('backend.admin.banquet.sttings.contractor.miscellaneous.store')}}" method="post">
					{{csrf_field()}}
					<div class="row">
					...
					<div class="row" >
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 ...
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" placeholder="Contract Terms" name="miscellaneous_contract_terms">{{old('miscellaneous_contract_terms')}}</textarea>
							 </div>
						  </div>
					   </div>
					</div>
					<div class="row" >
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" placeholder="Payment" name="miscellaneous_payment">{{old('miscellaneous_payment')}}</textarea>
							 </div>
						  </div>
					   </div>
					</div>
					<div class="row" >
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" placeholder="Arrangements" name="miscellaneous_arrangements">{{old('miscellaneous_arrangements')}}</textarea>
							 </div>
						  </div>
					   </div>
					</div>
					<div class="row" >
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" placeholder="Cancellation" name="miscellaneous_cancellation">{{old('miscellaneous_cancellation')}}</textarea>
							 </div>
						  </div>
					   </div>
					</div>
					...
					<div class="row" >
					   <div class="col-md-12">
						  ...
						  <div class="form-group row">
							 <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
							 <div class="col-md-12">
								<textarea class="form-control" rows="3" placeholder="Force Majeure" name="force_majeure">{{old('force_majeure')}}
								</textarea>
							 </div>
						  </div>
					   </div>
