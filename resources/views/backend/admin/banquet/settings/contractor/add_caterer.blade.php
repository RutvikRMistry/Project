...
<div class="page-main">
   ...
   <div style="width: 100%; padding: 30px;">
      <div class="panel-body" style="background-color: #fff; ">
        ...
        <div>
		<form action="{{route('backend.admin.banquet.sttings.contractor.caterer.store')}}" method="post">
			{{csrf_field()}}
            <div class="row">
               ...
               <div class="col-lg-4 form-group">
                  ...
                  <input type="number" class="form-control" placeholder=" " name="phone" value="{{old('phone')}}" required />
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Contract Terms" name="caterer_contract_terms">{{old('Contract Terms')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Payment" name="caterer_payment">{{old('caterer_payment')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Staff Charge" name="caterer_staff_charge">{{old('caterer_staff_charge')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
						<textarea class="form-control" rows="3" placeholder="Guest Number" name="caterer_guest_number">{{old('caterer_guest_number')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Additional Meals" name="caterer_additional_meal">{{old('caterer_additional_meal')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Dietary Requirements" name="dietary_requirements">{{old('dietary_requirements')}} </textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Additional Beverages" name="additional_beverages">{{old('additional_beverages')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Food and Beverages"name="food_and_beverages">{{old('food_and_beverages')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Hire Equipment" name="hire_equipment">{{old('hire_equipment')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Waste Disposal" name="waste_disposal">{{old('waste_disposal')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Responsibility for Damage" name="responsibility_for_damage">{{old('responsibility_for_damage')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                    <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Disorderly Conduct"name="disorderly_conduct">{{old('disorderly_conduct')}} </textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Responsible Service of Alcohol" name="responsible_service_of_alcohol">{{old('responsible_service_of_alcohol')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Safety & Hygiene" name="safety_and_hygiene">{{old('safety_and_hygiene')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Reschedule" name="reschedule">{{old('reschedule')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Indemnification" name="indemnification">{{old('indemnification')}}</textarea>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="form-group row">
                     <label class="col-md-2form-control-lg form-control-label" for="inputSizingLarge"></label>
                     <div class="col-md-12">
                        <textarea class="form-control" rows="3" placeholder="Binding Arbitration" name="binding_arbitration">{{old('binding_arbitration')}}</textarea>
