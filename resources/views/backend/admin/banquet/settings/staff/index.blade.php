 ...
 <div class="page">
   ...
   <div class="page-header">
      ...
      <div class="page-header-actions">
         ...
         <a href="{{route('backend.admin.banquet.sttings.staff.add')}}">
         <button type="button" class="btn btn-primary" style="margin: auto;"><i class="icon wb-plus mr-10" aria-hidden="true"></i> Invite</button></a>
      </div>
   </div>
				  ...
				  @foreach($user as $user)
					 ...
					 <td>{{$full_name}} </td>
                        ...
                        <td class="actions">
                           ...
                           <a href="{{route('backend.admin.banquet.sttings.staff.edit',$user->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
