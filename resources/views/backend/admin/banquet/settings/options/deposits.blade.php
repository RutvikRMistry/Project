...
<div class="page-main">
   <div class="page-header">
      <h1 class="page-title">Deposits  Type</h1>
      <div class="page-header-actions">
         <a href="{{route('backend.admin.banquet.sttings.option.deposit.add')}}">
                  ...
                  <tbody>
					@foreach($deposit as $dep)
						<tr>
						  ...
						  <a href="{{route('backend.admin.banquet.sttings.option.deposit.edit',$dep->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
							 data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
						  <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$dep->id}},'{{route('backend.admin.banquet.sttings.option.deposit.delete',$dep->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
						  </td>      
						</tr>
					@endforeach
                  </tbody>
