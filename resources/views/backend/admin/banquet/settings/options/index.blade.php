	...
	<div class="page-main">
	   <div class="page-header">
		  ...
		  <div class="page-header-actions">
			 <a href="{{route('backend.admin.banquet.sttings.option.add')}}">
				...
				<div class="col-lg-12 ">
				   <select class="form-control" data-plugin="select2">
					  <optgroup label="Please Select" >
						 <option value="R1">Priorty</option>
						 <option value="R1">Payment </option>
						 <option value="R1">Privacy</option>
						 <option value="R1">Show times</option>
						 <option value="R1">Lost Reason</option>
						 <option value="R1">Interval</option>
						 <option value="R1">Currency</option>
						 <option value="R1">Stages</option>
					  </optgroup>
				   </select>
				</div>
			 </div>
					...
					@foreach($option as $option)
						 <tr>
							...
							<td class="actions">
							   ...
							   <a href="{{route('backend.admin.banquet.sttings.option.edit',$option->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
								  data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
							   <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row"
								data-toggle="tooltip" data-original-title="Remove" onclick="deleteBlog({{$option->id}},'{{route('backend.admin.banquet.sttings.option.delete',$option->id)}}');"><i class="icon wb-trash" aria-hidden="true"></i></a>
